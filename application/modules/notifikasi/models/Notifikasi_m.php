...
class Notifikasi_m extends CI_Model
{
	...
	public function simpan_pengajuan_cuti()
	{
		...
		if ($ok) {
			...
			$this->db->where('nomor', $notif['no_referensi'])->update('pengajuan_cuti', [
				'approve_atasan1' => $this->input->post('approval'),
			...
			$pusher = new Pusher\Pusher(
				'fe9ea621076c080d7f3d',
				'5ab9630157101e86937a',
				'971855',
				$options
			);
			...
			$this->db->insert('notif', [
				'id' => hash_id(time()), 'no_referensi' => $notif['no_referensi'], 'nik_target' => $notif['nik_client'],
